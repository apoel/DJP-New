              ...
              <form action="<?php echo base_url()?>/SetDB/addJenisPajak" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        ...
                        <input type="text" class="form-control" name="alert1" placeholder="12" required>
                  </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        ...
                        <input type="text" class="form-control" name="alert2" placeholder="11" required>
                  </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Mitigasi Resiko</label>
                    <div class="col-md-8">
                    <input type="text" class="form-control" name="alert3" placeholder="10" required>
                  </div>
                </div>
               <div class="form-group row">
